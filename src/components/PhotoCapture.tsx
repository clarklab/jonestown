  ...
  if (preview) {
    return (
      ...
      >
        ...
        >
          <Icon name="close" size={20} weight={200} color="var(--color-ink)" />
        </motion.button>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="flex size-12 items-center justify-center rounded-full bg-tennis-200 ring-1 ring-inset ring-tennis-500/30">
        <Icon name="photo_camera" size={24} weight={200} color="var(--color-ink)" />
      </div>
  ...
  return (
    ...
    >
      {preview ? (
        ...
        <Icon name="add" size={24} weight={200} color="var(--color-ink-muted)" />
      )}
      <input
        ref={inputRef}
        type="file"
